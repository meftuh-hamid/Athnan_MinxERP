Ext.ns('Ext.erp.ux.productionPlanItem');

/**
* @desc      user grid

* @copyright (c) 2012, 
* @namespace Ext.erp.ux.productionPlanItem
* @class     Ext.erp.ux.productionPlanItem.Grid
* @extends   Ext.grid.GridPanel
*/
var selectionModel = new Ext.grid.RowSelectionModel();

Ext.erp.ux.productionPlanItem.Grid = function (config) {
    Ext.erp.ux.productionPlanItem.Grid.superclass.constructor.call(this, Ext.apply({
        store: new Ext.data.DirectStore({
            directFn: ProductionPlan.GetAllItem,
            paramsAsHash: false,
          ...
          //  idProperty: 'Id',
            ...
            fields: ['Id', 'ProductionPlanHeaderId', 'ItemId', 'Description','UnitId', 'Unit', 'StoreId', 'Store', 'Quantity', 'ConsumedQuantity', 'RemainingQuantity', 'UnitCost', 'Remark'],
            remoteSort: true,
            listeners: {
                beforeLoad: function () { Ext.getCmp('productionPlanItem-grid').body.mask('Loading...', 'x-mask-loading'); },
                load: function () { Ext.getCmp('productionPlanItem-grid').body.unmask(); },
                loadException: function () { Ext.getCmp('productionPlanItem-grid').body.unmask(); },
                scope: this
            }
        }),
        id: 'productionPlanItem-grid',
        pageSize: 20,
        height:250,
        stripeRows: true,
        border: false,
        ...
        columns: [{
        ...
        }, new Ext.grid.RowNumberer(),
          {
              ...
              editor: new Ext.form.ComboBox(
                  {
                      ...
                      store: new Ext.data.DirectStore({
                          reader: new Ext.data.JsonReader({
                              ...
                              idProperty: 'Id',
                              root: 'data',
                              fields: ['Id', 'Name', 'UnitId', 'MeasurementUnit', 'Color', 'Size']
                          }),
                          autoLoad: true,
                      ...
                      listeners: {
                          select: function (cmb, rec, idx) {
                              var grid = Ext.getCmp('productionPlanItem-grid');
                              ...
                              if (index == -1) {
                                  ...
                                  selectedrecord.set('Color', rec.get("Color"));
                                  selectedrecord.set('Size', rec.get("Size"));
                              }
                              else {
                                  Ext.MessageBox.show({
                                      title: 'Error',
              ...
              header: 'RemainingQuantity Quantity',
              sortable: false,
              width: 100,
              menuDisabled: true,
              editor: new Ext.form.NumberField({
...
Ext.extend(Ext.erp.ux.productionPlanItem.Grid, Ext.grid.EditorGridPanel, {
    initComponent: function () {
        ...
        this.tbar = [
            ...
            disabled: false,
            handler: function () {
                var detailDrid = Ext.getCmp('productionPlanItem-grid');
            ...
            handler: function () {
                ...
                var id = itemGrid.productionPlanId;
        ...
        this.bbar = [
            ...
            id: 'productionPlanItem-paging',
            store: this.store,
            displayInfo: true,
            pageSize: this.pageSize
        })];
        Ext.erp.ux.productionPlanItem.Grid.superclass.initComponent.apply(this, arguments)
    },
    onSave: function () {
        ...
        ProductionPlan.SaveItem(productionPlanId, rec, function (result) {
            if (result.success) {
                Ext.getCmp('productionPlanItem-paging').doRefresh();
                Ext.MessageBox.show({
                    title: 'Success',
                    msg: result.data,
                    buttons: Ext.Msg.OK,
    ...
    afterRender: function () {
        ...
        Ext.erp.ux.productionPlanItem.Grid.superclass.afterRender.apply(this, arguments);
    }
});
Ext.reg('productionPlanItem-grid', Ext.erp.ux.productionPlanItem.Grid);
...
* @namespace Ext.erp.ux.productionPlanItem
* @class     Ext.erp.ux.productionPlanItem.Window
* @extends   Ext.Window
*/
Ext.erp.ux.productionPlanItem.Window = function (config) {
    Ext.erp.ux.productionPlanItem.Window.superclass.constructor.call(this, Ext.apply({
        title: 'Item Units',
        layout: 'hbox',
        width: 500,
...
Ext.extend(Ext.erp.ux.productionPlanItem.Window, Ext.Window, {
    initComponent: function () {
        this.grid = new Ext.erp.ux.productionPlanItem.Grid(
            {
                itemId: this.itemId
            });
        ...
        Ext.erp.ux.productionPlanItem.Window.superclass.initComponent.call(this, arguments);
    },
    onSave: function () {
...
Ext.reg('productionPlanItem-Window', Ext.erp.ux.productionPlanItem.Window);
