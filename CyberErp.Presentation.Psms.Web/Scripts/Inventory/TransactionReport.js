Ext.ns('Ext.erp.ux.rptTransaction');
...
* @date      April 24, 2012
* @namespace Ext.erp.ux.rptTransaction
* @class     Ext.erp.ux.rptTransaction.Form
* @extends   Ext.form.FormPanel
*/
Ext.erp.ux.rptTransaction.Form = function (config) {
    Ext.erp.ux.rptTransaction.Form.superclass.constructor.call(this, Ext.apply({
        api: {
        ...
        items: [{
            ...
            store: new Ext.data.ArrayStore({
                ...
                data: [
                    ...
                    ['Transfer Issue', 'Transfer Issue'],
                    ['Transfer Receive', 'Transfer Receive'],
                    ['Receive', 'Receive'],
                    ['Return', 'Return'],
                    ['Adjustment', 'Adjustment'],                  
                    ['Delivery Order', 'Delivery Order'],
                    ['Reorder Sheet', 'Reorder Sheet'],
            ...
            listeners: {
                ...
                select: function (cmb, rec, idx) {
                    var form = Ext.getCmp('rptTransaction-form').getForm();
        ...
        buttons: [{
            ...
            handler: function () {
                var form = Ext.getCmp('rptTransaction-form');
                form.getForm().submit({
                    waitMsg: 'Please wait...',
                    success: function () {
                        var iframePanel = Ext.getCmp('rptTransaction-iframePanel');
                        var url = 'Reports/ErpReportViewer.aspx?rt=Transaction' + '&' + (new Date).getTime();
            ...
            iconCls: 'icon-exit',
            handler: function () {
                form = Ext.getCmp('rptTransaction-form').getForm();
                form.reset();
...
Ext.extend(Ext.erp.ux.rptTransaction.Form, Ext.form.FormPanel);
Ext.reg('rptTransaction-form', Ext.erp.ux.rptTransaction.Form);
...
* @extends   Ext.Panel
*/
Ext.erp.ux.rptTransaction.Panel = function (config) {
    Ext.erp.ux.rptTransaction.Panel.superclass.constructor.call(this, Ext.apply({
        layout: 'fit',
        border: false,
        tbar: {
            xtype: 'toolbar',
...
Ext.extend(Ext.erp.ux.rptTransaction.Panel, Ext.Panel, {
    initComponent: function () {
        this.url = 'Reports/ErpReportViewer.aspx';
        this.form = new Ext.erp.ux.rptTransaction.Form();
        ...
        this.items = [{
            ...
            items: [{
                ...
                border: true,
                layout: 'fit',
                id: 'rptTransaction-iframePanel',
                items: [this.iframeComponent]
            }]
        }];

        Ext.erp.ux.rptTransaction.Panel.superclass.initComponent.apply(this, arguments);
    }
});
Ext.reg('rptTransaction-panel', Ext.erp.ux.rptTransaction.Panel);
